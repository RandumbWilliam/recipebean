...
Before each handoff, confirm the relevant pipeline file exists and includes Context7/version notes when framework, library, SDK, API, or test utility behavior was involved.
